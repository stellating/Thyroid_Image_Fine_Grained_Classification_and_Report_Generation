...
def caption_image_beam_search(rev_word_map, result_file, encoder, encoder_crop, encoder_text, decoder, image_path, crop_image_path, feature, word_map, feature_map, beam_size=3):
    """
    ...
    crop_img = imread(crop_image_path)
    if len(img.shape) == 2:
        img = img[:, :, np.newaxis]
        img = np.concatenate([img, img, img], axis=2)
    if len(crop_img.shape) == 2:
        crop_img = crop_img[:,:,np.newaxis]
        crop_img = np.concatenate([img,img,img],axis=2)
...
def print_results(img, seq, rev_word_map, smooth=True):
    """
...
if __name__ == '__main__':
    ...
    image_dir = '/home/gyt/gyt/data/images/'
    ...
    crop_image_dir = '/home/gyt/gyt/data/crop_image_nlp'
    # parser.add_argument('--crop_img', '-ci',
    #                     default=[crop_image_dir + '/004837.jpg', crop_image_dir + '/004838.jpg',
    #                              crop_image_dir + '/004839.jpg'],
    #                     help='path to crop image')
    # parser.add_argument('--feature', '-f', default=['004151224132700000001434200', '002321111120000000000000000',
    #                                                 '001521110000000000000000000'], help='feature of image')

    # parser.add_argument('--crop_img', '-ci',
    #                     default= [crop_image_dir+'/004883.jpg',crop_image_dir+'/004884.jpg',crop_image_dir+'/004885.jpg'],
    #                     help='path to crop image')
    # parser.add_argument('--feature','-f', default=['100122022132100000012222000','100122224132100000012202000','100122113132100000002201000'], help = 'feature of image')

    # parser.add_argument('--crop_img', '-ci',
    #                     default= [crop_image_dir+'/000000.jpg',crop_image_dir+'/000001.jpg',crop_image_dir+'/000002.jpg',crop_image_dir+'/000003.jpg',crop_image_dir+'/000004.jpg'],
    #                     help='path to crop image')
    # parser.add_argument('--feature','-f', default=['100122214132100000001202000','100122214100100000001202000','000000000000001111200000001','100122214132100000001202000','100122214130000000001202000'], help = 'feature of image')
    parser.add_argument('--crop_img', '-ci',
    ...
    parser.add_argument('--model', '-m', default='./checkpoint/BEST-GYT-1209-CROP-alpha-checkpoint_thyroid_10_cap_per_img_0_min_word_freq.pth.tar',help='path to model')
    parser.add_argument('--word_map', '-wm', default='../flask/models/WORDMAP_thyroid_10_cap_per_img_0_min_word_freq.json',help='path to word map JSON')
    parser.add_argument('--feature_map', '-fm',
                        default='../flask/models/FEATURE_thyroid_10_cap_per_img_0_min_word_freq.json',
    ...
    parser.add_argument('--result_file','-rf',default='results.txt',help='path to result file')
    ...
    for i in range(len(args.img)):
        ...
        seq = caption_image_beam_search(rev_word_map, args.result_file, encoder, encoder_crop, encoder_text,
                                                decoder, img, crop_img, feature, word_map, feature_map, args.beam_size)
        seq=seq[0]
        words = [rev_word_map[ind] for ind in seq]
        print(words)
