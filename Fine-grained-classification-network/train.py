...
def main():
    ...
    parser.add_argument('--fine_tune_encoder', default=False,
...
def train(opt,train_loader, encoder, encoder_crop, encoder_text, decoder, criterion, encoder_optimizer, encoder_crop_optimizer, decoder_optimizer, epoch):
    """
    ...
    for i, (img_idx, imgs, crop_imgs, feature, caps, caplens, all_captions) in enumerate(train_loader):
        ...
        # print('scores_ori:',scores.shape)
        # print('targets_ori:',targets.shape)

        # Remove timesteps that we didn't decode at, or are pads
        # pack_padded_sequence is an easy trick to do this
        scores = pack_padded_sequence(scores, decode_lengths, batch_first=True)[0]
        targets = pack_padded_sequence(targets, decode_lengths, batch_first=True)[0]
        # print('scores:',scores.shape)  # batch_size, vocab_size
        ...
        # Add doubly stochastic attention regularizationalphasregularizationalphas
...
def validate(opt,val_loader, encoder, encoder_crop, encoder_text, decoder, criterion):
    """
